...
It requires oml4py installed, and that must be a Linux box.
...
Alternatively, you can use the oml4py package to load the model directly into the database. See the example in the doc:
